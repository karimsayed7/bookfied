            ...
            <div className="max-w-4xl mx-auto flex flex-col gap-8">
                ...
                <div className="vapi-header-card">
                    <div className="vapi-cover-wrapper">
                        ...
                        <div className="vapi-mic-wrapper relative">
                            ...
                            <button
                                ...
                                className={`vapi-mic-btn shadow-md !w-[50px] !h-[50px] z-10 ${isActive ? 'vapi-mic-btn-active' : 'vapi-mic-btn-inactive'}`}
                            >
                                {isActive ? (
                    ...
                    <div className="flex flex-col gap-4 flex-1">
                        <div>
                            <h1 className="text-lg sm:text-xl font-bold font-serif text-[#212a3b] mb-1">
                                {book.title}
                            </h1>
